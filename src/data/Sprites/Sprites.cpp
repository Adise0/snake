...
Sprite Sprites::head_left = Sprite(std::vector<std::u32string>{U" -/(.)", U"<bb---", U" -\\(.)"});
Sprite Sprites::head_up = Sprite(std::vector<std::u32string>{U" -^^- ", U"/ || \\", U"(.)(.)"});
Sprite Sprites::head_down = Sprite(std::vector<std::u32string>{U"(.)(.)", U"\\ || /", U" -vv- "});


Sprite Sprites::tail_right = Sprite(std::vector<std::u32string>{U"-/^---", U"<b---b", U"-\\v---"});
Sprite Sprites::tail_left = Sprite(std::vector<std::u32string>{U"---^\\-", U"b---b>", U"---v/-"});
Sprite Sprites::tail_up = Sprite(std::vector<std::u32string>{U"---^\\-", U"b---b>", U"---v/-"});
Sprite Sprites::tail_down = Sprite(std::vector<std::u32string>{U"---^\\-", U"b---b>", U"---v/-"});
